      ...
      <div class="card p-7">
        ...
        <div class="app-brand justify-content-center mt-5">
          {{-- <a href="{{url('/')}}" class="app-brand-link gap-3"> --}}
            ...
            <span class="app-brand-text demo text-heading fw-semibold">Bimbel</span>
          {{-- </a> --}}
        </div>
        <!-- /Logo -->
        <div class="card-body mt-1">
          ...
          <form id="formAuthentication" class="mb-5" action="{{ route('register') }}" method="POST">
            ...
            <div class="form-floating form-floating-outline mb-5">
                <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Enter your fullname" autofocus value="{{ old('fullname') }}">
